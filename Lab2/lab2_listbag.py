...
class ListBag:
    ...
    def remove(self, item: any) -> any:
        ...
        return self._elems.pop(self._elems.index(item))
    ...
    def grab(self) -> any:
        ...
        return self._elems.pop(self._elems.index(random.choice(self._elems)))
    ...
    def __add__(self, other: 'ListBag') -> 'ListBag':
        ...
        if not isinstance(other, ListBag):
            ...
            new_bag = ListBag()
            new_bag._elems = self._elems + other._elems
            return new_bag
    ...
    def __eq__(self, other: 'ListBag') -> bool:
        ...
        False
        """
        if not isinstance(other, ListBag) or sorted(self._elems) != sorted(other._elems):
            return False
